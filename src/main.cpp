...
const char *ssid = "Buffalo-G-75F0";
const char *password = "547v36fxxa56x";
// const char* ssid     = "嵐";
// const char* password = "jpexdapyu0e2";
// ==== SDピン設定 ====
    ...
    case 2:
    {
      ...
      while (1)
      {
        ...
        if (minute == 0 && second == 0)
        {
          ...
          M5.Lcd.setTextColor(WHITE);
          M5.Lcd.printf("%02d:%02d:%02d\n", hour, minute, second);
          playWAVfromSD("/matukare.wav");
          delay(1000); // 1秒待って二重再生防止
        }
        delay(500);
        M5.update();
        int preminute = minute;
      }
      break;
    }
    }
